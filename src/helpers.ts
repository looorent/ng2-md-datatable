...
export function customFeatureStoreModule(reducerFn: Function, initialState: IDatatablesState): ModuleWithProviders {
  return {
    ...
    providers: [
      {
        ...
        useFactory: () => {
          ...
          // TODO: remove this, that's for debugging
          dispatcher.subscribe(({ type, payload }) => console.log(`ACTION: ${type} ${JSON.stringify(payload)}`));
